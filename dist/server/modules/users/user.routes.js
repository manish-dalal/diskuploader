...
userRoutes.put('/:id', (0, _asyncWrapper.asyncWrapper)(_users.users.update)); // This route uses mysql DB for demo purpose to just show how can one use mysql in this app
